...
public class ExceptionHandler implements Thread.UncaughtExceptionHandler {
    public void uncaughtException(Thread t, Throwable e) {
        plugin.getLogger().severe("An error occoured! This is an exception. This may be an error with Admincore or an error with something else. We're not sure, but it's most likely an error with Admincore. For debugging purposes, here's the details:");
