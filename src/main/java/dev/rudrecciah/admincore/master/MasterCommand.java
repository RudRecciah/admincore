...
public class MasterCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if(args.length < 4) {
            ...
            sender.sendMessage(ChatColor.YELLOW + "Hey, I'm Admincore! Learn more at https://rudrecciah.dev/admincore and find other plugins in the Core family at https://rudrecciah.dev/core!");
            return true;
        }else if(args[0].equalsIgnoreCase("REPORT") && plugin.getServer().getOfflinePlayer(args[1]).hasPlayedBefore() || plugin.getServer().getOfflinePlayer(UUID.fromString(args[1])).hasPlayedBefore() && Integer.parseInt(args[2]) > 0 && Integer.parseInt(args[2]) < 9) {
            ...
            if(args[3].equalsIgnoreCase("uuid")) {
            ...
            return true;
        }else if(args[0].equalsIgnoreCase("MUTE") && plugin.getServer().getOfflinePlayer(args[1]).hasPlayedBefore() || plugin.getServer().getOfflinePlayer(UUID.fromString(args[1])).hasPlayedBefore() && Integer.parseInt(args[2]) > 0 && Integer.parseInt(args[2]) < 9) {
            int i = Integer.parseInt(args[2]);
            if(args[3].equalsIgnoreCase("player")) {
                OfflinePlayer target = plugin.getServer().getOfflinePlayer(args[1]);
                if(args.length > 4 && args[4].equalsIgnoreCase("api")) {
            ...
            return true;
        }else if(args[0].equalsIgnoreCase("TEMPBAN") && plugin.getServer().getOfflinePlayer(args[1]).hasPlayedBefore() || plugin.getServer().getOfflinePlayer(UUID.fromString(args[1])).hasPlayedBefore() && Integer.parseInt(args[2]) > 0 && Integer.parseInt(args[2]) < 9) {
            int i = Integer.parseInt(args[2]);
            if(args[3].equalsIgnoreCase("player")) {
                OfflinePlayer target = plugin.getServer().getOfflinePlayer(args[1]);
            ...
            return true;
        }else if(args[0].equalsIgnoreCase("BAN") && plugin.getServer().getOfflinePlayer(args[1]).hasPlayedBefore() || plugin.getServer().getOfflinePlayer(UUID.fromString(args[1])).hasPlayedBefore() && Integer.parseInt(args[2]) > 0 && Integer.parseInt(args[2]) < 9) {
            int i = Integer.parseInt(args[2]);
            if(args[3].equalsIgnoreCase("player")) {
                OfflinePlayer target = plugin.getServer().getOfflinePlayer(args[1]);
                StringBuilder appeal = new StringBuilder();
            ...
            return true;
        }else if(args[0].equalsIgnoreCase("IPBAN") && Integer.parseInt(args[2]) > 0 && Integer.parseInt(args[2]) < 9) {
            int i = Integer.parseInt(args[2]);
            if(args[3].equalsIgnoreCase("player")) {
                OfflinePlayer target = plugin.getServer().getOfflinePlayer(args[1]);
                StringBuilder appeal = new StringBuilder();
